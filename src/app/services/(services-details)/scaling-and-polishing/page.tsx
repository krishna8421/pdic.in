      ...
      <div className="space-y-8">
        <section className="mx-auto max-w-4xl">
          <p className="text-lg mb-4">
            Scaling and Polishing is a comprehensive cleaning process that
            reaches areas your toothbrush cannot, ensuring thorough oral
            hygiene.
          </p>
          <h2 className="text-2xl font-bold mb-4">What is Scaling?</h2>
          <p className="text-lg mb-4">
            Scaling is the removal of plaque and calculus (hard deposits) that
            accumulate on teeth and cannot be removed by routine brushing.
          </p>
          <h2 className="text-2xl font-bold mb-4">What is Polishing?</h2>
          <p className="text-lg mb-4">
            Polishing involves removing stains and tiny particles of calculus to
