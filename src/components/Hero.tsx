  ...
  <FlexSection>
    <div className="flex-1">
      <h1 className="text-[2.6rem] font-bold tracking-wide">
        Exceptional<span className="text-accent"> Dental Care </span>at your convenience
      </h1>
      ...
      <div className="mt-16 flex items-center gap-7">
        <ButtonLink href="https://wa.me/917028332893" _target="blank">Schedule Your Visit</ButtonLink>
